# Dante_KRX_Reverse_Breakout_1D_LS_Pro.py
...
def scan_market_1d():
    ...
    print(f"\n⚡ [일봉 전용] 한국장 P(역매공파) LS OpenAPI 스캔 시작!")
    t0 = time.time()
...
def run_scheduler():
    ...
    print("🕒 [한국장 P 스케줄러 (1D 전용)] 09:30 / 11:30 / 14:30 대기 중...")
    while True:
        now_kr = datetime.now(kr_tz)
        if (now_kr.hour == 9 and now_kr.minute == 20) or \
           (now_kr.hour == 11 and now_kr.minute == 20) or \
           (now_kr.hour == 14 and now_kr.minute == 20):
