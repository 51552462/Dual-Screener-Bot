...
| 마지막 갱신 | 2026-08-03 | B-3 shadow impl |
...
| 9′ | **A paper + L/B 병렬** | **진행중** | L-1·L-2 Claude OK · B-1~B-3 OK | L-1/L-2 **서버 설치 대기** · **3-track shadow 관측** | A `06` + B-2 + B-3 shadow **병렬** |
| 10 | B: 진화/deathmatch | **진행중** | key fix·alloc shadow OK·WF shadow OK | B-1 OK ✅ · B-2 shadow OK ✅ · B-3 shadow OK ✅ | alloc prod off · WF promotion block off · **3개 shadow 병렬 관측** |
