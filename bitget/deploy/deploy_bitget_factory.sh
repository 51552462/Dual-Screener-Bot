...
sudo chmod +x "${INSTALL_ROOT}/deploy/install_director_digest_cron.sh"
sudo chmod +x "${INSTALL_ROOT}/bitget/deploy/install_bitget_logrotate.sh"
sudo chmod +x "${INSTALL_ROOT}/bitget/deploy/install_bitget_backup.sh"
...
echo ""
echo "[deploy_bitget] log rotation (L-1 P0-1):"
echo "  sudo INSTALL_ROOT=${INSTALL_ROOT} ${INSTALL_ROOT}/bitget/deploy/install_bitget_logrotate.sh"
echo "  sudo .../install_bitget_logrotate.sh --test   # logrotate -d + journal vacuum dry-run"
echo "[deploy_bitget] integrity backup (L-2 P0-5):"
echo "  sudo INSTALL_ROOT=${INSTALL_ROOT} ${INSTALL_ROOT}/bitget/deploy/install_bitget_backup.sh"
echo "  sudo .../install_bitget_backup.sh --test      # backup + restore drill dry-run"
echo ""
