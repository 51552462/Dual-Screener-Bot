...
if TYPE_CHECKING:
    from evolution.deathmatch_battle_royale import BattleRoyaleResult, RegistryArmRow
...
def apply_deathmatch_allocation_to_meta(
    ...
    *,
    ...
    if save_config_audit and isinstance(sys_config, dict):
        from evolution.deathmatch_report import apply_allocation_proposal_to_config
